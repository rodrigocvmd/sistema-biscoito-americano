...
const INVENTORY_DATA = [
	...
	{
		category: "PACOTE DE COOKIES",
		items: [
			"PACOTE COOKIE CLÁSSICO AO LEITE",
			"PACOTE COOKIE NUTELLA",
			"PACOTE COOKIE BRIGADEIRO",
			"PACOTE COOKIE PISTACHE",
			"PACOTE COOKIE MACADAMIA",
			"PACOTE COOKIE OVOMALTINE",
			"PACOTE COOKIE NEW YORK",
			"PACOTE COOKIE M&M'S",
			"PACOTE COOKIE CREME BRÜLLE",
			"PACOTE COOKIE KINDER BUENO",
			"PACOTE COOKIE LÓTUS",
			"PACOTE COOKIE BROWNIE",
			"PACOTE COOKIE TRIPLO CHOCOLATE",
			"PACOTE COOKIE RED NINHO",
			"PACOTE COOKIE RED NUTELLA",
			"PACOTE COOKIE OREO",
			"PACOTE COOKIE CLÁSSICO RED",
			"PACOTE COOKIE ECLIPSE",
			"PACOTE COOKIE ALPINO",
			"PACOTE COOKIE AMERICAN COOKIE",
		],
	},
	{
		category: "OUTROS",
